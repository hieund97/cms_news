...
class Product extends Model
{
    ...
    {
        return $this->belongsToMany(static::class, 'product_relates', 'product_id', 'relate_id')->withPivot('sort')->orderBy('sort');
    }
    ...
    {
        return $this->belongsToMany(static::class, 'product_similars', 'product_id', 'similar_id')->withPivot('sort')->orderBy('sort');
    }
