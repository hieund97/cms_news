...
class ProductController extends Controller
{
    ...
    public function update(ProductUpdate $request, $product): RedirectResponse
    {
        ...
        return redirect()->route('products.edit', ['product' => $product->id])->with('success', __('Edited success'));
    }
    ...
    public function showSort(Request $request, $categoryId)
    {
        ...
        $products = Product::ignoreGlobalEagerLoading()
            ...
            ->orderByDesc(DB::raw('FIELD(`id`, ' . implode(',', array_reverse(explode(',', $order->orders))) . ')'))
            ->get([
                'id',
                'name',
                'product_category_id',
